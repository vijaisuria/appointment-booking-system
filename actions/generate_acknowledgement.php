...
<body>
    <header>
        <p style="color: red">Please click the "Download" button to obtain the appointment receipt electronically.</p>
        <p>
            Kindly note, it is not necessary to carry a printed copy of the receipt. <br>
            You may simply download the e-receipt or conveniently retain the appointment number. <br>
            Alternatively, displaying your acknowledgment email
        ...
        <div class="row">
            ...
            <div class="receipt-main col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <p style=" margin-top: -5px; text-align: right; font-weight: bolder">
                                        <?php echo $status ?>
                                    </p>
                                </td>
                                <td>
                ...
                <div class="footer">
                    ...
                    <p class="credit">Developed and Maintained by <a
                            href="http://www.health-centre.mitindia.edu/team.html" target="_blank" class="credit">MIT
                            Health centre web team</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <?php
    //if download query parameter is print invoke print()
    if (isset($_GET['download']) && $_GET['download'] == 'print') {
        printReciept();
    }
